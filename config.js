...
global.blockJids= process.env.BLOCK_JID || "120363029115223817@g.us"
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "255657779003,255xxxxxxxx";
...
module.exports = {
  ...
  menu: process.env.MENU || "", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Shakira-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/
  ...
  ownername:process.env.OWNER_NAME|| "It's Benjamini",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "SHAKIRA",
